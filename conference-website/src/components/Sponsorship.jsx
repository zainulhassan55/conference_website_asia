...
export default function Sponsorship({ showHeading = true }) {
  return (
    <section id="sponsorship" className="py-20 lg:py-28 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-2 gap-8 max-w-5xl mx-auto">
          <div className="rounded-3xl p-8 lg:p-10 bg-slate-50 border border-slate-100">
            ...
            <p className="text-slate-500 text-sm mb-5">As a sponsor, your organization will have the opportunity to:</p>
            <ul className="space-y-3">
              {sponsorshipBenefits.map((benefit) => (
                <li key={benefit} className="flex items-start gap-3 text-slate-600 text-sm sm:text-base">
          ...
          <div className="rounded-3xl p-8 lg:p-10 bg-slate-50 border border-slate-100 flex flex-col justify-center">
            ...
            <div className="p-5 rounded-2xl bg-ieee-blue/5 border border-ieee-blue/20 mb-6">
              <p className="text-ieee-blue font-semibold text-sm">Contact for Sponsorship</p>
              <a
                href={`mailto:${conference.contact.sponsorshipEmail}`}
                className="text-slate-900 text-lg font-bold mt-1 hover:text-ieee-blue transition-colors break-all"
              >
            ...
            <a
              ...
              className="inline-flex justify-center px-8 py-3.5 bg-gradient-to-r from-ieee-blue to-ieee-light text-white font-semibold rounded-xl hover:shadow-lg hover:shadow-ieee-blue/30 transition-all"
            >
