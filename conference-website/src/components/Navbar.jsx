        ...
        <div className="flex items-center justify-between h-16 lg:h-[5rem] gap-4">
          <Link to="/" className="flex items-center gap-2 sm:gap-3 group shrink-0 min-w-0">
            <img
              ...
              className="h-9 sm:h-10 lg:h-11 w-auto object-contain drop-shadow-md group-hover:scale-[1.02] transition-transform"
            />
          ...
          <button
            ...
            className="lg:hidden p-2.5 text-white rounded-lg hover:bg-white/10 transition-colors shrink-0"
